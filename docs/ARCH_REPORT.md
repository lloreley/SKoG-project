...
> **Примечание по автоматизации:** Ввиду ранней стадии разработки и использования Godot Engine, классические инструменты (IBM Rational Rose) заменяются анализом дерева узлов и визуализацией связей через PlantUML.

---
[МЕСТО ДЛЯ КАРТИНКИ] ![Архитектура проекта](./images/AsIs.pngg)
...
| **Управление состоянием** | **Децентрализованное.** Счетчик монет хранится внутри переменной в `player.gd`. | **Централизованное.** Состояние хранится в Game Manager / Ресурсах данных. |
