...
var dialog_lines: Array = [
	"Сначала не было ничего... только бесконечная, тяжелая пустота.",
	"Затем пришел звук. Далекий шелест листвы, напоминающий шепот забытых имен.",
	"Ты чувствуешь запах сырой земли и старой хвои. Холод пробирается под одежду.",
	"Мир вокруг кажется чужим, словно ты здесь — лишь незваный гость.",
	"Лес ждет. Он наблюдал за твоим сном слишком долго.",
	"Твои глаза открываются, но туман в мыслях не спешит уходить.",
	"Пора оставить тени позади. Впереди только неизвестность.",
	"[shake rate=30 level=12]ВСТАВАЙ.[/shake]"
]
